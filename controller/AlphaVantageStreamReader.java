...
/**
 * Represents the reader for Alpha Vantage.
 */
public class AlphaVantageStreamReader implements IReader {
  private final String ticker;

  /**
   * Creates the object with a stock ticker.
   *
   * @param ticker for the desired stock.
   */
  ...
  /**
   * Gets stock data as a readable.
   *
   * @return Returns a readable that contains the stock data of the ticker in this reader
   */
